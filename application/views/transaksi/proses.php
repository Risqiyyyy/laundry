        ...
        <div class="row">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">DATA SEDANG DI PROSES</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Data Semua Transaksi Status Proses</li>
                    </ol>
                    <!-- tabel -->
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
										...
										?>
                                                    ...
                                                    <td>
                                                    <a href="<?= site_url('transaksi/selesai_update/'.$u->transaksi_id) ?>" class="btn btn-info">Selesai</a>
